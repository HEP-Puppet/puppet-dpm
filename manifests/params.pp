class dpm::params {
  ...
  $configure_star = hiera('dpm::params::configure_star', false)
  ...
  $oidc_allowissuer   = hiera('dpm::params::oidc_allowissuer',[])
  $oidc_allowaudience = hiera('dpm::params::oidc_allowaudience',[])

  $argus_banning = hiera('dpm::params::argus_banning', undef)
  ...
  $xrootd_async = hiera('dpm::params::xrootd_async','on')

  #xrootd tuning
  $xrd_timeout = hiera('dpm::params::xrd_timeout',undef)
  $xrootd_jemalloc = hiera('dpm::params::jemalloc',true)
  $xrootd_sec_level = hiera('dpm::params::xrootd_sec_level',undef)
  ...
  $repos = hiera('dpm::params::repos', {
    'epel' => {
      ...
      'baseurl'  => "http://linuxsoft.cern.ch/epel/${facts['os']['release']['major']}/\$basearch",
      'gpgcheck' => 0,
      'enabled'  => 1,
      'protect'  => 1,
    },
